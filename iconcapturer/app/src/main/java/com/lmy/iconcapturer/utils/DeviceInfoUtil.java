...
public class DeviceInfoUtil {
    ...
    public static String getBasicInfo(Context context){
        ...
        builder.append(getPhoneModel() + " ");
        builder.append(getOS() + " ");
        builder.append(getResolution(context) + " ");
    ...
    public static String getOS() {
        XLog.w( "操作系统:" + "Android" + android.os.Build.VERSION.RELEASE);
    ...
    public static String getResolution(Context context) {
        ...
        XLog.w( "分辨率：" + screenWidth + "*" + screenHeight);
    ...
    public String getMEID(Context context) {
        ...
        if (null != mTelephonyMgr) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                XLog.i( "Android版本大于o-26-优化后的获取---meid:" + meid);
            } else {
                meid = mTelephonyMgr.getDeviceId();
            }
        }

        XLog.i( "优化后的获取---meid:" + meid);
    ...
    public String getIMEI(Context context) {
        ...
        if (null != mTelephonyMgr) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                XLog.i( "Android版本大于o-26-优化后的获取---imei-1:" + imei1);
            } else {
                try {
                    ...
                    XLog.e( "get device id fail: " + e.toString());
                }
            }
        }

        XLog.i( "优化后的获取---imei1：" + imei1);
        return imei1;
    }
    ...
    public String getIMEI2(Context context) {
        ...
        if (null != mTelephonyMgr) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                XLog.i( "Android版本大于o-26-优化后的获取---imei-2:" + imei2);
            } else {
                try {
